...
def get_args():
    ...
    parser.add_argument('--config', '-c', default='base', type=str, help='[base/lfw/ms1mv3]')
...
def main():
    ...
    backbone = get_backbone(cfg.model_name, cfg.fp16, cfg.output_size, cfg.bkb_ckpt_path)
